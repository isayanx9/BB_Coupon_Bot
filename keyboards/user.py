...
def join_keyboard():
    ...
    kb.button(text=BTN_JOIN_CHANNEL, url=f"https://t.me/{CHANNEL_USERNAME.lstrip('@')}", style="primary")
    kb.button(text=BTN_JOIN_GROUP, url=f"https://t.me/{GROUP_USERNAME.lstrip('@')}", style="primary")
    kb.button(text=BTN_VERIFY, callback_data="verify_user", style="success")
    kb.adjust(1)
    return kb.as_markup()
